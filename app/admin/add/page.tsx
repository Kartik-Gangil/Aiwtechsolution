        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-6">Add New Business</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className='flex gap-3 items-center'>
                                ...
                                {/* <button
                                    className=' rounded px-2 bg-indigo-500 hover:bg-fuchsia-500 text-white font-bold transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 cursor-pointer'
                                    onClick={() => generateDescription(formData.name, formData.category, formData.address)}>Generate Description</button> */}
                            </div>
                            <textarea
                                name="description"
